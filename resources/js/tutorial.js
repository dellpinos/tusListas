...
(async function () {
    ...
    if (document.querySelector('.sidebar')) {
        ...
        if (!respuesta.tutorial && respuesta.tutorial_lvl === 1) {
        ...
        else if (!respuesta.tutorial && respuesta.tutorial_lvl === 3) {
        ...
        } else if (!respuesta.tutorial && respuesta.tutorial_lvl === 5) {
        ...
        // Mensaje Categorias
        if (!respuesta.tutorial && respuesta.tutorial_lvl === 2) {
        ...
        // Mensaje Fabricantes
        if (!respuesta.tutorial && respuesta.tutorial_lvl === 4) {
        ...
        // Mensaje Providers
        if (!respuesta.tutorial && respuesta.tutorial_lvl === 6) {
        ...
        if (!respuesta.tutorial && respuesta.tutorial_lvl === 7) {
        ...
        if (!respuesta.tutorial && respuesta.tutorial_lvl === 8) {
