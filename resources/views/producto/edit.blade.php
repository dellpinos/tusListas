        ...
        <div class="producto-formulario__contenedor">
            <div class="producto-formulario__contenedor-sm">
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <input type="text" id="name" name="nombre" placeholder="Nombre del producto" @if($producto_fraccionado) readonly @endif
                        class="formulario__campo @if($producto_fraccionado) formulario__campo--no-activo @endif @error('nombre') borde__error @enderror" value="{{ $producto->nombre }}">
                    @error('nombre')
                        <p class="alerta__error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <select class="formulario__campo @if($producto_fraccionado) formulario__campo--no-activo @endif @error('categoria') borde__error @enderror" id="categoria"
                        name="categoria_id" @if($producto_fraccionado) readonly @endif>
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <select class="formulario__campo @if($producto_fraccionado) formulario__campo--no-activo @endif @error('proveedor') borde__error @enderror" id="proveedor"
                        name="provider_id" @if($producto_fraccionado) readonly @endif>
                ...
                <div class="formulario__campo-contenedor">
                    <label for="fabricante" class="formulario__label">Laboratorio -
                        Fabricante</label>
                    <select class="formulario__campo @if($producto_fraccionado) formulario__campo--no-activo @endif @error('fabricante') borde__error @enderror" id="fabricante"
                        name="fabricante_id" @if($producto_fraccionado) readonly @endif>
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <input type="number" id="dolar" name="dolar" placeholder="0"
                        value="{{ $precio->dolar }}" class="formulario__campo text-right @error('dolar') borde__error @enderror">
                    @error('dolar')
                        <p class="alerta__error">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="producto-formulario__contenedor-sm">
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <input type="number" id="precio" name="precio" placeholder="0"
                        value="{{ $precio->precio }}" class="formulario__campo text-right @error('precio') borde__error @enderror">
                    @error('precio')
                        <p class="alerta__error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="producto-formulario__flex producto-formulario__contenedor-checkbox">
                    ...
                    <a href="{{route('producto.show', $producto_secundario)}}" class="producto-formulario__venta-boton">Producto Fraccionado</a>
            ...
            <div class="producto-formulario__flex"> {{-- <<< Definir esta clase --}}
                ...
                <div class="formulario__campo-contenedor width-full">
                    ...
                    <input type="text" id="unidad-fraccion" name="unidad_fraccion" placeholder="blister, frasco, ml, kg"
                        value="{{ $producto->unidad_fraccion }}" class="formulario__campo @error('unidad-fraccion') borde__error @enderror">
                ...
                <div class="formulario__campo-contenedor width-full">
                    ...
                    value="{{ $producto->contenido_total }}" class="formulario__campo text-right @error('contenido-total') borde__error @enderror">
                ...
                <div class="formulario__campo-contenedor width-full">
                    ...
                    value="{{ $producto->ganancia_fraccion }}" class="formulario__campo text-right @error('ganancia-fraccion') borde__error @enderror">
