            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <input type="text" id="name" name="name" placeholder="Nombre de tu empresa"
                        class="formulario__campo @error('name') borde__error @enderror" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="formulario__campo-contenedor">
                    ...
                    <input type="text" id="usuario" name="usuario" placeholder="Tu nombre"
                        class="formulario__campo @error('usuario') borde__error @enderror" value="{{ old('usuario') }}">
                    @error('usuario')
                        <p class=" alerta__error">{{ $message }}</p>
                    @enderror
                </div>
                <div class="formulario__campo-contenedor">
                    ...
                    <input type="text" id="username" name="username" placeholder="Tu nombre de usuario"
                        class="formulario__campo @error('username') borde__error @enderror" value="{{ old('username') }}">
                    @error('username')
                        <p class=" alerta__error">{{ $message }}</p>
                    @enderror
                </div>
