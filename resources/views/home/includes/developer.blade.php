...
<div class="developer__contenedor">

    <h3>Detrás de TusListas</h3>
    <p class="developer__name">Hola! Soy <span>Martín del Pino</span></p>
    ...
    <div class="developer__contenedor-card">
        <div class="developer__card">
            ...
            <div class="developer__links">
                ...
                <a href="https://dellpinos.com/" target="_blank">¿Quieres conocer más sobre el desarrollador? Te invito a visitar el portafolio.</a>
            </div>
