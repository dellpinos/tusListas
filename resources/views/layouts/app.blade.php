...
<body class=" bg-gray-100">
    <header class=" p-5 border-b bg-gray-800 shadow-gray-400">
        <div class="container mx-auto flex justify-between items-center">
            ...
            @guest
                <nav class="flex gap-2 items-center">
                    <a class=" font-bold uppercase text-gray-600 text-sm hover:text-white" href="#">Login</a>
                    <a class=" font-bold uppercase text-gray-600 text-sm hover:text-white" href="#">Crear cuenta</a>
                </nav>
            @endguest
    ...
    <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        Tus Listas - Todos los derechos reservados {{ now()->year }}
