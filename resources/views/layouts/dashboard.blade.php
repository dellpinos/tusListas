    ...
    <main class="contenedor-xl">
        <aside class="sidebar">
            <nav class=" sidebar__nav">
                ...
                <a href="{{ route('ingreso') }}" class="sidebar__enlace @if(request()->path() === "ingreso") activo  @endif"><i class="fa-solid fa-clipboard sidebar__icono"></i>Ingreso Mercaderia</a>
                ...
                <a href="{{ route('aumentos') }}" class="sidebar__enlace @if(request()->path() === "aumentos") activo  @endif""><i class="fa-solid fa-dollar-sign sidebar__icono"></i>Cambiar Precios</a>
